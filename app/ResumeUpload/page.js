    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center w-full p-6">
        <div className="w-full max-w-[500px] bg-white mt-6 px-6 py-6 mb-10 shadow-lg rounded-xl p-8 transform transition-all duration-500 hover:scale-105 text-black">
          ...
          <form className="mt-5 flex flex-col gap-4 sm:gap-6" onSubmit={handleSubmit}>
            <input
              type="file"
              className="file-input file-input-bordered h-10 w-full sm:max-w-xs dark:bg-gray-700 dark:text-white text-black"
              multiple
            ...
            <button
              type="submit"
              className="bg-[#3B82F6] text-white font-semibold py-2 px-6 rounded-lg hover:bg-blue-600 transition duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 mt-4 sm:mt-2 w-full sm:w-auto hover:shadow-lg hover:scale-105"
            >
              Submit
            </button>
          </form>
